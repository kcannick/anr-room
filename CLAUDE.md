...
- `npm test` — full suite (scoring.test.js + sidebet.test.js + migrate.test.js + e2e.test.js). **Expected: 0 failed** (1,615 passed as of 2026-09-19; the count grows with features — green is the invariant).
